...
public class kmeams {
    static String DATA_PATH = "C:\\Users\\LiuJunshan\\Desktop\\大数据分析实验一\\2\\实验2数据\\聚类数据.txt";
    static String CENTER_PATH = "C:\\Users\\LiuJunshan\\Desktop\\大数据分析实验一\\2\\实验2数据\\centers.txt";
    static String NEW_CENTER_PATH = "C:\\Users\\LiuJunshan\\Desktop\\大数据分析实验一\\2\\实验2数据\\KMeans_new_center_path";
    ...
    public static void run(boolean runReduce) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(kmeams.class);
